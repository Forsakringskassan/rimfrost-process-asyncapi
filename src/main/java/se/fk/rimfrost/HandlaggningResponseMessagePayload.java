...
public class HandlaggningResponseMessagePayload implements Serializable
{
   ...
   @JsonProperty("data")
   private HandlaggningResponseMessageData data;
   @JsonAnySetter
   @JsonInclude(Include.NON_NULL)
   private HashMap<String, Object> additionalProperties;

   public HandlaggningResponseMessagePayload()
   {
   }
   ...
   public HandlaggningResponseMessageData getData()
   {
      return this.data;
   }

   public void setData(HandlaggningResponseMessageData data)
   {
      this.data = data;
   }
   ...
   public boolean equals(Object o)
   {
      ...
      {
         HandlaggningResponseMessagePayload self = (HandlaggningResponseMessagePayload) o;
   ...
   public String toString()
   {
      ...
      return "class HandlaggningResponseMessagePayload {\n    specversion: " + var10000 + "\n    id: "
